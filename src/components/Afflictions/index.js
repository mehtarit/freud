  ...
  render() {
    return (
      <div className="Afflictions">
        <h1 className="page-header">I need help with...</h1>
        <div className="AfflictionCardWrapper">
          {this.state.afflictions.map((affliction, index) => (
            <Link
              to="/resources"
            ...
            >
              <AfflictionCard
                ...
                afflictionPrompt={affliction.prompt}
              />
            </Link>
          ))}
        </div>
